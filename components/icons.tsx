...
export const SmartificiaIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <defs>
            <radialGradient id="smart-grad" cx="50%" cy="30%" r="50%" fx="50%" fy="30%">
                <stop offset="0%" stopColor="white" stopOpacity="0.7" />
                <stop offset="100%" stopColor="#25BCE9" />
            </radialGradient>
        </defs>
        <path d="M48.1 28.22C46.7 21 40.73 15.42 33.5 14.2A19.43 19.43 0 0010.5 24.39c-1 2.1-1.4 4.35-1.4 6.68 0 10.77 8.73 19.5 19.5 19.5a19.38 19.38 0 0012.75-4.66" fill="#0B2A6B"/>
        <path d="M10.5 24.39A19.47 19.47 0 0132 12.5c7.42 0 13.7 4.91 16.1 11.6l-29.5 6.3Z" fill="url(#smart-grad)"/>
        <path d="M54 12.9L28.89 33.82l-3.3-6.6 28-5.93a2.5 2.5 0 013.09 2.23L58 35.1" fill="#0B2A6B"/>
        <rect x="22.5" y="46" width="19" height="6" rx="1" fill="#0B2A6B" />
        <rect x="25.5" y="54" width="13" height="4" rx="2" fill="#25BCE9" />
    </svg>
);
...
export const BackgroundsIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" {...props}>
...
export const ContactsIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" {...props}>
        <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-2.253a9.527 9.527 0 0 0-1.262-1.262M15 19.128V14.628c0-1.313.879-2.428 2.11-2.849M15 19.128v-4.5m-9-3.75h9.563M15 19.128A9.37 9.37 0 0 1 12.128 3v4.5A9.37 9.37 0 0 1 15 19.128Zm-9.37 0A9.37 9.37 0 0 1 3.878 3v12.128a9.37 9.37 0 0 1 1.752 4Z" />
    </svg>
);

export const EmailSignaturesIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" {...props}>
